...
// PROJECTS is no longer imported from data.js

// Projects component now accepts props
export const Projects = ({ projectsData }) => {
  const [selectedId, setSelectedId] = useState(null);
  
  // Find the selected project from the prop array
    ...
    <section id="projects" className="py-20 bg-black/20">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {/* Map over the dynamic projectsData prop */}
        ...
        {/* The Modal (AnimatePresence, Dialog) logic remains the same */}
        {/* It will automatically use the dynamic `selectedProject` data */}
        <AnimatePresence>
