...
// We no longer import SKILLS here
// We must dynamically import the icons or have a mapping
import { Server, Code, Database, icons } from 'lucide-react';

// Icon mapping to dynamically render icons from string names
const iconMap = {
  Server: Server,
  Code: Code,
  Database: Database,
  // Add other lucide icon names here if needed
};

// Skills component now accepts props
    ...
    <section id="skills" className="py-20">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          {/* Map over the dynamic skillsData prop */}
          {Object.entries(skillsData).map(([category, data], idx) => {
            // Dynamically get the icon component
            const Icon = iconMap[data.icon] || Server; // Default to Server icon
